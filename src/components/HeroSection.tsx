        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-center md:text-left mb-12 md:mb-0">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
              Solusi Project <span className="text-orange-400">Programming</span> &amp; <span className="text-orange-400">Elektronika</span> dalam Satu Tempat
            </h1>
            <p className="text-xl text-gray-200 mb-8 max-w-lg mx-auto md:mx-0">
              Kami bantu realisasikan ide Anda dalam bentuk aplikasi atau perangkat berbasis mikrokontroler.
            </p>
